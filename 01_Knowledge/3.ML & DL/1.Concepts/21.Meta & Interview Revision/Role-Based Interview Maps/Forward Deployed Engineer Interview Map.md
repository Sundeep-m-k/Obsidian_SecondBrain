# Forward Deployed Engineer — Interview Map

Pure navigation — wikilinks only, no re-explained content. This role's interviews lean toward applied system-building and LLM/agent fluency over classical ML theory depth — the tier weighting below reflects that.
...
[[Model Interpretability Index]] · [[SHAP]] · [[LIME]] · [[Metric Selection and Diagnosing Change]] · [[Confusion Matrix]] · [[Classification Metrics]] · [[A-B Testing]] · [[Correlation vs Causation]] · [[Feature Scaling]] · [[Data Leakage]] · [[Retraining and Model Maintenance]] · [[Online vs Offline Evaluation]]

## Also See

[[Applied AI and LLM Systems Index]] (full module, read in order) · [[Deep Learning Index]] · [[Schema Trust]], [[Entity Resolution]] (Databases module — data-quality judgment shows up constantly in applied/client-facing work)

*Note: classical ML algorithm derivations (SVM math, exact tree-splitting criteria, etc.) are lower priority for this role than for AI/ML Engineer or Data Scientist — prioritize the Applied AI & LLM Systems module and production-reliability judgment first.*
