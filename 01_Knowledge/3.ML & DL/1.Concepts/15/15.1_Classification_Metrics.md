...
This trade-off is unavoidable; you must choose based on the cost of FP vs. FN in your application. See [[15.2_ROC_and_PR_Curves]] for how to visualize and optimize this. See [[Thresholding]].
...
- [[15.2_ROC_and_PR_Curves]] — visualizing the precision-recall trade-off
- [[15.6_Class_Imbalance_Evaluation]] — when F1 and AUC-PR matter most
